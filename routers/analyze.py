...
async def analyze_photos(
    ...
    try:
        ...
        def generate_pdf_report(object_counts, timestamp, mask_img, color_map, class_labels, user_info=None):
            ...
            # 免责声明
            disclaimer = "Disclaimer: This report is generated by MyOral.ai using AI analysis. For a professional diagnosis, please consult a licensed dentist."
